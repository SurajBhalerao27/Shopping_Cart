...
import com.db.dao.impl.CustomerDaoImpl;
import com.db.dao.impl.LoginDaoImpl2;
			...
			if (i == 1) {
				...
				if (limpl.adminLogin(email, password)) {
					...
					while (exit == false) {
						...
						case 2:
							...
							if (plist != null && plist.isEmpty() != true) {
								...
								System.err
										.println("Unable to show products at this moment!! Please try again later...");
							break;
							...
							if (plist != null && plist.isEmpty() != true) {
								...
								if (p != null) {
									...
									if (choice.equalsIgnoreCase("yes")) {
										...
										if (flag)
											System.out
													.println("Product with ID " + productId + " deleted successfully.");
										else
					...
					while (exit == false) {
						...
						System.out.println("22--------> Update customer");
