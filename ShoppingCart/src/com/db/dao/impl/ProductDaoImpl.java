...
public class ProductDaoImpl implements ProductDao {
	...
	public Boolean addProduct(Product p) {
		...
		try {
			...
			sql = "insert into Product(productName, productType, price, quantityInStock, rating, description) values(?,?,?,?,?,?)";
	...
	public Boolean updateProduct(Product p) {
		con = DBUtility.makeConnection();
		sql = "update product set productName=?, productType=?, price=?, quantityInStock=?, rating=?, description=? where productId=?";
